...
## 개요
`MyRoomEditorPropEditor`는 MyRoomEditor에서 오브젝트 편집을 위한 추상 베이스 클래스입니다. 이 클래스는 오브젝트 편집 기능의 기본 인터페이스를 제공하며, 선택된 오브젝트의 상태를 관리하고 [`MyRoomEditorPropEditingManager`](/docs/projects/rfice/housingsystem/myroomeditorpropeditingmanager/)를 통해 받은 입력 및 UI 동작에 대한 이벤트를 서브 클래스를 통해 처리합니다.
...
- [`IMyRoomEditorEditableObject`](/docs/projects/rfice/HousingSystem/IMyRoomEditorEditableObject), [`SpawnablePropBase`](/docs/projects/rfice/HousingSystem/SpawnablePropBase) 인터페이스 사용.
...
- [`MyRoomPropSelector`](/docs/projects/rfice/housingsystem/myroompropselector/)
- [`MyRoomPropMover`](/docs/projects/rfice/housingsystem/myroompropmover/)
- [`MyRoomPropRotator`](/docs/projects/rfice/housingsystem/myroomproprotator/)