...
- **제작기간**: 2025.06 ~ 2025.09
- **시스템 개발 인원**: 3인 (유니티 클라이언트 2인, 백엔드 1인)
...
| **Unity Input System** | 입력 이벤트 처리 및 디바이스 독립적 입력 관리 |
...
| **[AchievementInteractor](/docs/projects/rfice/SlimeRush/AchievementSystem/AchievementInteractor)** | 데이터 인터랙터 구현체, JSON 직렬화/역직렬화 처리 |
...
classDiagram
    ...
    AchievementSystem --> AchievementInteractor: uses
```
...
| **[IAchievementRepository](/docs/projects/rfice/SlimeRush/AchievementSystem/IAchievementRepository)** | 저장소 인터페이스 |
...
| 클래스 | 역할 |
|-----|-----|
| **[AchievementRepository](/docs/projects/rfice/SlimeRush/AchievementSystem/AchievementRepository)** | 저장소 패턴 구현, 데이터 소스 추상화 |
| **[LocalAchievementDataSource](/docs/projects/rfice/SlimeRush/AchievementSystem/LocalAchievementDataSource)** | 로컬 파일 시스템 데이터 소스 |
| **[CloudSyncDataSource](/docs/projects/rfice/SlimeRush/AchievementSystem/CloudSyncDataSource)** | Steam 클라우드 저장소 데이터 소스 |
...
classDiagram
    ...
    AchievementPopup --> AchievementSystem: subscribes
